...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                axios.get('/Projects/laravel-passport-oAuth2-example/server/public/oauth/clients')
                        .then(response => {
            ...
            store() {
                this.persistClient(
                    'post',
                    '/Projects/laravel-passport-oAuth2-example/server/public/oauth/clients',
                    this.createForm,
                    '#modal-create-client'
                );
            },
            ...
            update() {
                this.persistClient(
                    'put',
                    '/Projects/laravel-passport-oAuth2-example/server/public/oauth/clients/' + this.editForm.id,
                    this.editForm,
                    '#modal-edit-client'
                );
            },
             ...
             */
            destroy(client) {
                axios.delete('/Projects/laravel-passport-oAuth2-example/server/public/oauth/clients/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }
